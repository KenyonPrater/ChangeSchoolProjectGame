...
public class WorldRefs {
	...
	public static String[] carrusel = {"/res/lvl/1-2.tmx","/res/lvl/1-2.tmx","/res/blankmap.tmx","/res/lvl/3-8.tmx"};
	...
	public static String[] school = {"/res/lvl/1-5.tmx","/res/lvl/1-5.tmx","/res/lvl/2-2.tmx","/res/lvl/3-5.tmx"};
	public static String[] insideschool = {"/res/lvl/1-6.tmx","/res/lvl/1-6.tmx","/res/lvl/2-1.tmx","/res/lvl/3-4.tmx"};
